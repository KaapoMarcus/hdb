...
class evalVisitor implements IExpressionVisitor
{
	...
	Object eval_constant( TExpression expr ) throws Exception
	{
		...
		if ( (constant.getNodeType( ) == ENodeType.T_Constant.getId( ) && isString(constant.toString())) || constant.getNodeType( ) == ENodeType.T_Constant_String.getId( ) )
		{
		...
		else if ( (constant.getNodeType( ) == ENodeType.T_Constant.getId( ) && isInteger(constant.toString())) || constant.getNodeType( ) == ENodeType.T_Constant_Integer.getId( ) )
		{
		...
		else if ( (constant.getNodeType( ) == ENodeType.T_Constant.getId( ) && isFloat(constant.toString())) ||  constant.getNodeType( ) == ENodeType.T_Constant_Float.getId( ) )
		{
