package com.jhh.hdb.sqlparser2.analyzescript;
/*
 * Date: 12-9-13
 */
...
public class tutorial {
    ...
    public static void main(String args[]){
        ...
        sqlparser.sqltext = "SELECT e.last_name      AS name,\n" +
                ...
                "  e.first_name,\n" +
                "  e.last_name;";
sqlparser.sqltext="select ID,EMAIL from user_info union select USER_ID,COME_FROM from user_info_etc;";
sqlparser.sqltext="SELECT ID, GMT_CREATE FROM user.user_info where GMT_CREATE >= '2015-11-01 00:00:00' AND GMT_CREATE <= '2015-11-06 23:59:59' AND IS_FAKE = 0 AND ENABLE = 1 AND ID NOT IN (select USER_ID from user.user_r_fanli ) ;";
sqlparser.sqltext="SELECT t11.ID, t11.GMT_CREATE, t12.COME_FROM FROM ( select t1.ID,t1.GMT_CREATE FROM ( SELECT ID, GMT_CREATE FROM user.user_info where GMT_CREATE >= '2015-11-01 00:00:00' AND GMT_CREATE <= '2015-11-06 23:59:59' AND IS_FAKE = 0 AND ENABLE = 1 ) t1 LEFT OUTER JOIN user.user_r_fanli t2 ON ( t1.ID = t2.USER_ID ) where t2.USER_ID is NULL )t11 INNER JOIN user.user_info_etc t12 ON(t11.ID = t12.USER_ID) ORDER BY t11.GMT_CREATE ; ";
