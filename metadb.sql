...
CREATE TABLE nodeinstance  (
    nodeinstance_id int not null  AUTO_INCREMENT ,
...
CREATE TABLE nodedb  (
    nodedb_id int not null AUTO_INCREMENT ,
...
CREATE TABLE hdb  (
    hdb_id int not null AUTO_INCREMENT ,
...
CREATE TABLE htable  (
    htable_id int not null AUTO_INCREMENT ,
...
CREATE TABLE hdp  (
    hdp_id int not null AUTO_INCREMENT ,
...
CREATE TABLE hcolumn  (
    hcolumn_id int not null AUTO_INCREMENT ,
...
CREATE TABLE hindex  (
    hindex_id int not null AUTO_INCREMENT ,
    htable_id int not null default 0 ,
    hindex_type int not null default 0 ,
...
replace into nodeinstance values (  0,'10.199.134.41' ,3306 ) ;
replace into nodeinstance values (  1,'10.199.134.42' ,3306 ) ;
